    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='eg. X5, E-Class, M4...' required 
            className='px-3 py-2 mt-1 border border-borderColor rounded-md 
        ...
        {/* Car Location */}
        {/* Add the map feature for this instead of selecting the location manually */}
          <div className='flex flex-col w-full'>
            <label>Location</label>
            <select onChange={e => setCar({...car, fuel_type: e.target.value})} value={car.location}
              className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='eg. A laxurious SUV with a spacious interior and a powerful engine' required 
            className='px-3 py-2 mt-1 border border-borderColor rounded-md 
