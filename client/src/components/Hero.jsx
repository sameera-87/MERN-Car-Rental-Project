...
const Hero = () => {
    ...
    const {pickUpDate, settPickupDate, returnDate, setReturnDate, navigate} = useAppContext()
  ...
  return (
    ...
    bg-light text-center'>
        ...
        bg-white shadow-[0px_8px_20pxrgba(0,0,0,0.1)]'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-10 md:ml-8'>
                ...
                <div className='flex flex-col items-start gap-2'>
                    ...
                    <input value={pickUpDate} onChange={e=> settPickupDate(e.target.value)} type="date" id="pickup-date" min={new Date().toISOString().split('T')[0]} 
